...
public protocol SwapQuotesProvidable: Sendable {
    ...
    func fetchQuotes(wallet: Wallet, fromAsset: Asset, toAsset: Asset, amount: BigInt) async throws -> [SwapperQuote]
}
...
public struct SwapQuotesProvider: SwapQuotesProvidable {
    ...
    public func fetchQuotes(wallet: Wallet, fromAsset: Asset, toAsset: Asset, amount: BigInt) async throws -> [SwapperQuote] {
