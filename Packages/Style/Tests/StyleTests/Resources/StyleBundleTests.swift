...
final class BundleTests: XCTestCase {
    ...
    func testBundleFinderCandidates() {
        let candidates = generateCandidateURLs(for: MockBundleFinder.self, bundleName: "Style_Style")
    ...
    func testLoggingWhenBundleNotFound() {
        ...
        let candidates = generateCandidateURLs(for: MockBundleFinder.self, bundleName: bundleName)
    ...
    // Helper method to generate candidate URLs
    private func generateCandidateURLs(for bundleFinderClass: AnyClass, bundleName: String) -> [URL?] {
