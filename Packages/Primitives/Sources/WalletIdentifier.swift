...
public enum WalletIdentifier: Equatable, Hashable, Sendable {
    ...
    public static func from(id: String) throws -> WalletIdentifier {
    ...
    public static func make(walletType: WalletType, chain: Chain, address: String) -> WalletIdentifier {
        switch walletType {
