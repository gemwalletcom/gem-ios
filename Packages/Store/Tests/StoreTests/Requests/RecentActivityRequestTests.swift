...
struct RecentActivityRequestTests {
    ...
    func fetchRecentAssets() throws {
        ...
        try store.add(assetId: btc, walletId: WalletId(id: ""), type: .search, createdAt: now.addingTimeInterval(-2))
        try store.add(assetId: bnb, walletId: WalletId(id: ""), type: .search, createdAt: now.addingTimeInterval(-1))
        try store.add(assetId: btc, walletId: WalletId(id: ""), type: .transfer, createdAt: now)
