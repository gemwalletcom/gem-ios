...
public enum Localized {
  ...
  public enum Info {
    ...
    public enum StakeMinimumAmount {
      /// Some validators may have a minimum staking requirement. For %@, the minimum staking amount is %@.
      public static func description(_ p1: Any, _ p2: Any) -> String {
        return Localized.tr("Localizable", "info.stake_minimum_amount.description", String(describing: p1), String(describing: p2), fallback: "Some validators may have a minimum staking requirement. For %@, the minimum staking amount is %@.")
      }
      /// Minimum Amount
