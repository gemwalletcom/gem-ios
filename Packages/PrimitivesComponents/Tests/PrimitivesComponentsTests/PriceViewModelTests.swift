...
struct PriceViewModelTests {
    ...
    func testPriceAmountText() {
        ...
        #expect(PriceViewModel(price: .mock(price: 0.000000123), currencyCode: currencyCode).priceAmountText == "$0.00000012")
        #expect(PriceViewModel(price: .mock(price: 0.00000000123), currencyCode: currencyCode).priceAmountText == "$0.0000000012")
        #expect(PriceViewModel(price: .mock(price: -10), currencyCode: currencyCode).priceAmountText == "-$10.00")
